    ...
    def thread_main(self, sess):
        ...
        while not stop:
            ...
            for i in ids:
                ...
                num_iter = int(np.floor((tot_len - self.frame_length) / self.frame_move - self.N_IN))
